...
// Shared by Talk It Through and Lesson Debrief's Reflect voice mode — both
// need the identical sentence-splitting/prefetch/playback behavior
// (including the Chrome streamed-audio-blob quirk below), so this lives in
