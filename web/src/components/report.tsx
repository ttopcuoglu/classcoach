...
// globally, and every ReportSection carries an explicit page break so a
// teacher can hand one section to a coach without the rest. And it has to
// stay honest: where a value could not be determined, print a dash and its
